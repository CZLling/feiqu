...
public enum  ResultEnum {
    ...
    POST_THOUGHT_FREQUENCY_OVER_LIMIT("0033","发表随笔频率超过限制，请过一分钟再试!"),
    THOUGHT_COMMENT_FREQUENCY_OVER_LIMIT("0034","随笔评论频率超过限制，请过一分钟再试!"),
    POST_ARTICLE_FREQUENCY_OVER_LIMIT("0035","发表笔记频率超过限制，请过一分钟再试!"),
    ...
    THOUGHT_TOO_LONG("0040","随笔长度不能超过400~"),
    PIC_URL_SAME("0041","图片地址不能和之前的一样!"),
    THOUGHT_TOP_EXIST("0042","置顶的随笔已经存在!"),
